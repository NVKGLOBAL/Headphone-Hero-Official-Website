...
const AlbumCard: React.FC<AlbumCardProps> = ({ album, index }) => {
  ...
  return (
    <a 
      ...
      className="bg-deep-purple/50 backdrop-blur-md rounded-lg overflow-hidden group block transition-all duration-300 hover:scale-105 hover:box-glow animate-fade-in-up"
